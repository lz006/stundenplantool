...
public class GreetingServiceImpl extends RemoteServiceServlet implements
	...
	public String greetServer(Dozent dozent) throws IllegalArgumentException {
		// Verify that the input is valid. 
		if (!FieldVerifier.isValidName(dozent.getVorname())) {
		...
		dozentTest.insertIntoDB(dozent);
		...
		return "Sieht gut aus!!!" + serverInfo;
	}
